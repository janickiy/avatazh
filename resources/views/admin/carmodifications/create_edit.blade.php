...
@section('content')
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li>
                <a href="{{ url('admin/carmodifications/model/' . (isset($carmodification) ? $carmodification->id_car_model : $id_car_model) ) }}"><i
                            class="fa fa-list-alt"></i> Модификации</a></li>
            <li class="active"><i
                        class="fa {{ isset($carmodification) ? 'fa-pencil' : 'fa-plus' }}"></i> {{ isset($carmodification) ? 'Редактировать' : 'Добавить' }}
                модификацию
            </li>
        </ol>
    </section>
