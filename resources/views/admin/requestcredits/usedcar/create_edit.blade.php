...
@section('content')
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="{{ url('admin/requestcredits') }}"><i class="fa fa-list-alt"></i> Заявки на автокредит
                    (Автомобили с пробегом)</a></li>
            <li class="active"><i
                        class="fa {{ isset($requestcredit) ? 'fa-pencil' : 'fa-plus' }}"></i> {{ isset($requestcredit) ? 'Редактировать' : 'Добавить' }}
